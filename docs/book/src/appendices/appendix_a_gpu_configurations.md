...
Управление охлаждением выполняется скриптом `adjust_cooling` (см. [Hardware_Isolation.md](hardware_isolation.md)).

---

## A5. Мониторинг PCIe Sideband (SMBus)

Для обнаружения скрытых атак на GPU используется расширенный мониторинг PCIe Sideband через Arduino (см. [Isolation_and_Sandbox.md](Isolation_and_Sandbox.md), раздел 4.2).
...
- **Изоляция и watchdog:** [Isolation_and_Sandbox.md](Isolation_and_Sandbox.md)
