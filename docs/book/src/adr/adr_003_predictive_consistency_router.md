...
- **ConsistencyRouter и GlobalState:** [Global_State_and_Decision_Pipeline.md](Global_State_and_Decision_Pipeline.md)
- **Strict AST-First Merge:** [Memory_Hierarchy_Mem0g.md](Memory_Hierarchy_Mem0g.md) (раздел 2.2)
- **L0 Meta-Mem0g интеграция:** [Memory_Hierarchy_Mem0g.md](Memory_Hierarchy_Mem0g.md) (раздел 8)
