...
- **Реализация роутера:** [Memory_Hierarchy_Mem0g.md](Memory_Hierarchy_Mem0g.md) (раздел 6)
- **Fast Path интеграция:** [Global_State_and_Decision_Pipeline.md](Global_State_and_Decision_Pipeline.md) (раздел 2.3)
- **L0 Meta‑Mem0g и обучение матрицы:** [Memory_Hierarchy_Mem0g.md](Memory_Hierarchy_Mem0g.md) (раздел 8)
