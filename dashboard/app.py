...
def _update_global_prometheus_gauges(metrics_dict: Dict[str, NodeMetrics]) -> None:
    """
    Updates global Prometheus gauges with node metrics data.

    Args:
        metrics_dict: Dictionary mapping node names to their NodeMetrics data.

    Raises:
        ValueError: If a non-finite numerical value is encountered.
    """
...
def prometheus_metrics() -> PlainTextResponse:
    """
    Prometheus metrics endpoint. Collects data and returns Prometheus format.
    """
