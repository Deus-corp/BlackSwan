...
- **Виды (Species‑as‑Experts):** [Global_State_and_Decision_Pipeline.md](../01_Core_Architecture/Global_State_and_Decision_Pipeline.md)
- **Meat‑Interface 3.0 (DeepSight):** [Meat_Interface_Tasking.md](../03_Domains/Physical_and_Human_Interface/Meat_Interface_Tasking.md)
- **Constitutional Debate 2.0:** [Neuro_Symbolic_Governance.md](../03_Domains/Cognitive_Evolution/Neuro_Symbolic_Governance.md)
- **План миграции на железо:** [Hardware_Transition_Plan.md](../02_Bootstrap_and_Deployment/Hardware_Transition_Plan.md)