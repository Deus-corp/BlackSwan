...
# Regex pattern to extract simulation metrics from node container logs.
...
def collect_metrics() -> Dict[str, Dict[str, Any]]:
    ...
    for container in containers:
        try:
            # Fetch recent logs to extract latest metrics
            ...
            logger.warning("Failed to process logs for container %s: %s", container.name, e)
...
def prometheus_format(metrics: Dict[str, Dict[str, Any]]) -> str:
    ...
    Args:
        metrics: Dictionary of node metrics generated by collect_metrics.

    Returns:
        A string formatted for Prometheus scrapers.
    """
    lines: List[str] = [
