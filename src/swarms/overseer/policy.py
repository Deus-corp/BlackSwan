...
# Constants for hard policy constraints
...
class PolicyEngine:
    ...
    def merge(
        self, hard_rules: OverseerDecision, llm_suggestions: Mapping[str, Any] | None
    ) -> OverseerDecision:
        ...
        # Safety-first merge logic: hard constraints act as ceilings/floors
