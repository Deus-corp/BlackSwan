...
def check_controlled_execution_readiness(args: argparse.Namespace) -> dict[str, Any]:
    ...
    real_repair_approval_transition_from_statuses = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_from_statuses")
    )
    real_repair_approval_transition_to_statuses = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_to_statuses")
    )
    real_repair_approval_transition_source_approval_statuses = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_source_approval_statuses")
    )
    real_repair_approval_transition_source_review_statuses = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_source_review_statuses")
    )
    real_repair_approval_transition_next_actions = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_next_actions")
    )
    real_repair_approval_transition_operator_authorized = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_operator_authorized")
    )
    real_repair_approval_transition_required = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_required")
    )
    real_repair_approval_transition_approved = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_approved")
    )
    real_repair_approval_transition_rejected = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_rejected")
    )
    real_repair_approval_transition_repair_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_repair_execution_enabled")
    )
    real_repair_approval_transition_real_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_real_execution_enabled")
    )
    real_repair_approval_transition_subprocess_enabled = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_subprocess_enabled")
    )
    real_repair_approval_transition_repair_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_repair_execution_performed")
    )
    real_repair_approval_transition_repair_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_repair_subprocess_invoked")
    )
    real_repair_approval_transition_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_approval_transition_execution_performed")
    )
    ...
    real_repair_noop_feedback_statuses = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_statuses")
    )
    real_repair_noop_feedback_verified = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_verified")
    )
    real_repair_noop_feedback_path_can_proceed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_path_can_proceed")
    )
    real_repair_noop_feedback_next_gate_allowed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_next_gate_allowed")
    )
    real_repair_noop_feedback_next_actions = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_next_actions")
    )
    real_repair_noop_feedback_source_noop_statuses = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_noop_statuses")
    )
    real_repair_noop_feedback_source_exit_codes = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_exit_codes")
    )
    real_repair_noop_feedback_source_target_counts = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_target_counts")
    )
    real_repair_noop_feedback_source_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_execution_performed")
    )
    real_repair_noop_feedback_source_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_subprocess_invoked")
    )
    real_repair_noop_feedback_source_repair_actions_executed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_repair_actions_executed")
    )
    real_repair_noop_feedback_source_repair_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_repair_execution_enabled")
    )
    real_repair_noop_feedback_source_repair_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_repair_execution_performed")
    )
    real_repair_noop_feedback_source_repair_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_source_repair_subprocess_invoked")
    )
    real_repair_noop_feedback_feedback_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_feedback_execution_performed")
    )
    real_repair_noop_feedback_feedback_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_feedback_subprocess_invoked")
    )
    real_repair_noop_feedback_repair_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_repair_execution_enabled")
    )
    real_repair_noop_feedback_real_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_real_execution_enabled")
    )
    real_repair_noop_feedback_subprocess_enabled = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_subprocess_enabled")
    )
    real_repair_noop_feedback_repair_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_repair_execution_performed")
    )
    real_repair_noop_feedback_repair_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_repair_subprocess_invoked")
    )
    real_repair_noop_feedback_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_execution_performed")
    )
    real_repair_noop_feedback_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_noop_feedback_subprocess_invoked")
    )
    real_repair_readiness_gate_statuses = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_statuses")
    )
    real_repair_readiness_gate_satisfied = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_satisfied")
    )
    real_repair_readiness_gate_guarded_ready = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_guarded_ready")
    )
    real_repair_readiness_gate_ready_for_repair_execution = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_ready_for_repair_execution")
    )
    real_repair_readiness_gate_would_execute = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_would_execute")
    )
    real_repair_readiness_gate_next_actions = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_next_actions")
    )
    real_repair_readiness_gate_source_feedback_statuses = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_feedback_statuses")
    )
    real_repair_readiness_gate_source_noop_statuses = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_noop_statuses")
    )
    real_repair_readiness_gate_source_exit_codes = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_exit_codes")
    )
    real_repair_readiness_gate_source_target_counts = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_target_counts")
    )
    real_repair_readiness_gate_source_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_execution_performed")
    )
    real_repair_readiness_gate_source_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_subprocess_invoked")
    )
    real_repair_readiness_gate_source_repair_actions_executed = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_repair_actions_executed")
    )
    real_repair_readiness_gate_source_repair_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_repair_execution_enabled")
    )
    real_repair_readiness_gate_source_repair_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_repair_execution_performed")
    )
    real_repair_readiness_gate_source_repair_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_source_repair_subprocess_invoked")
    )
    real_repair_readiness_gate_repair_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_repair_execution_enabled")
    )
    real_repair_readiness_gate_real_execution_enabled = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_real_execution_enabled")
    )
    real_repair_readiness_gate_subprocess_enabled = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_subprocess_enabled")
    )
    real_repair_readiness_gate_repair_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_repair_execution_performed")
    )
    real_repair_readiness_gate_repair_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_repair_subprocess_invoked")
    )
    real_repair_readiness_gate_execution_performed = _safe_mapping(
        trail_summary.get("real_repair_readiness_gate_execution_performed")
    )
    ...
    real_execution_sandbox_adapter_scaffold_statuses = _safe_mapping(
        trail_summary.get("real_execution_sandbox_adapter_scaffold_statuses")
    )
    real_execution_sandbox_adapter_scaffold_fail_closed = _safe_mapping(
        trail_summary.get("real_execution_sandbox_adapter_scaffold_fail_closed")
    )
    real_execution_sandbox_adapter_scaffold_deny_by_default = _safe_mapping(
        trail_summary.get("real_execution_sandbox_adapter_scaffold_deny_by_default")
    )
    real_execution_sandbox_adapter_scaffold_sandbox_execution_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_adapter_scaffold_sandbox_execution_enabled"
        )
    )
    real_execution_sandbox_adapter_scaffold_execution_performed = _safe_mapping(
        trail_summary.get("real_execution_sandbox_adapter_scaffold_execution_performed")
    )
    real_execution_sandbox_adapter_scaffold_subprocess_invoked = _safe_mapping(
        trail_summary.get("real_execution_sandbox_adapter_scaffold_subprocess_invoked")
    )
    real_execution_sandbox_adapter_scaffold_real_execution_enabled = _safe_mapping(
        trail_summary.get("real_execution_sandbox_adapter_scaffold_real_execution_enabled")
    )
    real_execution_sandbox_adapter_scaffold_external_side_effects = _safe_mapping(
        trail_summary.get("real_execution_sandbox_adapter_scaffold_external_side_effects")
    )
    real_execution_sandbox_adapter_scaffold_production_paths_mutated = _safe_mapping(
        trail_summary.get(
    ...
    real_execution_sandbox_request_envelope_scaffold_statuses = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_request_envelope_scaffold_statuses"
        )
    )
    real_execution_sandbox_request_envelope_scaffold_fail_closed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_request_envelope_scaffold_fail_closed"
        )
    )
    real_execution_sandbox_request_envelope_scaffold_deny_by_default = _safe_mapping(
        trail_summary.get(
    ...
    real_execution_sandbox_workspace_plan_scaffold_statuses = _safe_mapping(
        trail_summary.get("real_execution_sandbox_workspace_plan_scaffold_statuses")
    )
    real_execution_sandbox_workspace_plan_scaffold_fail_closed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_workspace_plan_scaffold_fail_closed"
        )
    )
    real_execution_sandbox_workspace_plan_scaffold_deny_by_default = _safe_mapping(
        trail_summary.get(
    ...
    real_execution_sandbox_input_materialization_plan_scaffold_statuses = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_statuses"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_fail_closed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_fail_closed"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_deny_by_default = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_deny_by_default"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_plan_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_plan_generation_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_plan_materialized = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_plan_materialized"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_plan_executable = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_plan_executable"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_input_materialization_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_input_materialization_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_inputs_materialized = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_inputs_materialized"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_passed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_passed"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_directory_creation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_directory_creation_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_workspace_created = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_workspace_created"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_cleanup_registered = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_cleanup_registered"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_workspace_creation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_workspace_creation_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_command_rendering_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_command_rendering_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_sandbox_execution_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_sandbox_execution_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_result_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_result_generation_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_execution_performed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_execution_performed"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_subprocess_invoked = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_subprocess_invoked"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_real_execution_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_real_execution_enabled"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_external_side_effects_performed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_external_side_effects_performed"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_production_paths_mutated = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_production_paths_mutated"
        )
    )
    real_execution_sandbox_input_materialization_plan_scaffold_production_secrets_accessed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_production_secrets_accessed"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_statuses = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_statuses"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_fail_closed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_fail_closed"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_deny_by_default = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_deny_by_default"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_plan_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_plan_generation_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_plan_materialized = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_plan_materialized"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_plan_executable = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_plan_executable"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_command_rendering_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_command_rendering_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_command_rendered = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_command_rendered"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_rendered_command_validated = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_rendered_command_validated"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_input_plan_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_input_plan_generation_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_input_plan_materialized = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_input_plan_materialized"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_input_plan_executable = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_input_plan_executable"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_input_materialization_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_input_materialization_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_inputs_materialized = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_inputs_materialized"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_passed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_passed"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_directory_creation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_directory_creation_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_workspace_created = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_workspace_created"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_cleanup_registered = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_cleanup_registered"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_workspace_creation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_workspace_creation_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_sandbox_execution_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_sandbox_execution_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_result_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_result_generation_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_execution_performed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_execution_performed"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_subprocess_invoked = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_subprocess_invoked"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_real_execution_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_real_execution_enabled"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_external_side_effects_performed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_external_side_effects_performed"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_production_paths_mutated = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_production_paths_mutated"
        )
    )
    real_execution_sandbox_command_render_plan_scaffold_production_secrets_accessed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_command_render_plan_scaffold_production_secrets_accessed"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_statuses = _safe_mapping(
        trail_summary.get("real_execution_sandbox_rendered_command_scaffold_statuses")
    )
    real_execution_sandbox_rendered_command_scaffold_fail_closed = _safe_mapping(
        trail_summary.get("real_execution_sandbox_rendered_command_scaffold_fail_closed")
    )
    real_execution_sandbox_rendered_command_scaffold_deny_by_default = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_deny_by_default"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_generation_enabled"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_materialized = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_materialized"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_executable = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_executable"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_validated = _safe_mapping(
        trail_summary.get("real_execution_sandbox_rendered_command_scaffold_validated")
    )
    real_execution_sandbox_rendered_command_scaffold_command_plan_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_command_plan_generation_enabled"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_command_plan_materialized = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_command_plan_materialized"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_command_plan_executable = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_command_plan_executable"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_command_rendering_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_command_rendering_enabled"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_command_rendered = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_command_rendered"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_sandbox_execution_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_sandbox_execution_enabled"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_result_generation_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_result_generation_enabled"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_execution_performed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_execution_performed"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_subprocess_invoked = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_subprocess_invoked"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_real_execution_enabled = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_real_execution_enabled"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_external_side_effects_performed = _safe_mapping(
        trail_summary.get(
            "real_execution_sandbox_rendered_command_scaffold_external_side_effects_performed"
        )
    )
    real_execution_sandbox_rendered_command_scaffold_production_paths_mutated = _safe_mapping(
        trail_summary.get(
    ...
    return {
        ...
        "real_repair_approval_transition_observed": _safe_int(
            real_repair_approval_transition_to_statuses.get("approved"), 0
        )
        > 0,
        "real_repair_approval_transition_records": _safe_int(
            real_repair_approval_transition_to_statuses.get("approved"), 0
        ),
        "real_repair_approval_transition_linkage_complete": bool(
            trail_summary.get("real_repair_approval_transition_linkage_complete")
        ),
        "real_repair_approval_transition_orphans": _safe_int(
            trail_summary.get("real_repair_approval_transition_orphans"), 0
        ),
        "real_repair_approval_transition_from_pending": _safe_int(
            real_repair_approval_transition_from_statuses.get("pending"), 0
        ),
        "real_repair_approval_transition_to_approved": _safe_int(
            real_repair_approval_transition_to_statuses.get("approved"), 0
        ),
        "real_repair_approval_transition_source_approval_pending": _safe_int(
            real_repair_approval_transition_source_approval_statuses.get("pending"), 0
        ),
        "real_repair_approval_transition_next_action_final_gate": _safe_int(
            real_repair_approval_transition_next_actions.get(
                "prepare_repair_execution_final_gate"
            ),
            0,
        ),
        "real_repair_approval_transition_operator_authorized": _safe_int(
            real_repair_approval_transition_operator_authorized.get("true"), 0
        ),
        "real_repair_approval_transition_required": _safe_int(
            real_repair_approval_transition_required.get("true"), 0
        ),
        "real_repair_approval_transition_approved": _safe_int(
            real_repair_approval_transition_approved.get("true"), 0
        ),
        "real_repair_approval_transition_repair_execution_enabled": _safe_int(
            real_repair_approval_transition_repair_execution_enabled.get("true"), 0
        ),
        "real_repair_approval_transition_real_execution_enabled": _safe_int(
            real_repair_approval_transition_real_execution_enabled.get("true"), 0
        ),
        "real_repair_approval_transition_subprocess_enabled": _safe_int(
            real_repair_approval_transition_subprocess_enabled.get("true"), 0
        ),
        "real_repair_approval_transition_repair_execution_performed": _safe_int(
            real_repair_approval_transition_repair_execution_performed.get("true"), 0
        ),
        "real_repair_approval_transition_repair_subprocess_invoked": _safe_int(
            real_repair_approval_transition_repair_subprocess_invoked.get("true"), 0
        ),
        "real_repair_approval_transition_execution_performed": _safe_int(
            real_repair_approval_transition_execution_performed.get("true"), 0
        ),
        ...
        "real_repair_noop_feedback_observed": _safe_int(
            real_repair_noop_feedback_statuses.get("actionable"), 0
        )
        > 0,
        "real_repair_noop_feedback_records": _safe_int(
            real_repair_noop_feedback_statuses.get("actionable"), 0
        ),
        "real_repair_noop_feedback_linkage_complete": bool(
            trail_summary.get("real_repair_noop_feedback_linkage_complete")
        ),
        "real_repair_noop_feedback_orphans": _safe_int(
            trail_summary.get("real_repair_noop_feedback_orphans"), 0
        ),
        "real_repair_noop_feedback_actionable": _safe_int(
            real_repair_noop_feedback_statuses.get("actionable"), 0
        ),
        "real_repair_noop_feedback_verified": _safe_int(
            real_repair_noop_feedback_verified.get("true"), 0
        ),
        "real_repair_noop_feedback_path_can_proceed": _safe_int(
            real_repair_noop_feedback_path_can_proceed.get("true"), 0
        ),
        "real_repair_noop_feedback_next_gate_allowed": _safe_int(
            real_repair_noop_feedback_next_gate_allowed.get("true"), 0
        ),
        "real_repair_noop_feedback_next_action_readiness_gate": _safe_int(
            real_repair_noop_feedback_next_actions.get(
                "prepare_repair_execution_readiness_gate"
            ),
            0,
        ),
        "real_repair_noop_feedback_source_noop_completed": _safe_int(
            real_repair_noop_feedback_source_noop_statuses.get("completed"), 0
        ),
        "real_repair_noop_feedback_source_exit_code_zero": _safe_int(
            real_repair_noop_feedback_source_exit_codes.get("0"), 0
        ),
        "real_repair_noop_feedback_source_target_count_9": _safe_int(
            real_repair_noop_feedback_source_target_counts.get("9"), 0
        ),
        "real_repair_noop_feedback_source_execution_performed": _safe_int(
            real_repair_noop_feedback_source_execution_performed.get("true"), 0
        ),
        "real_repair_noop_feedback_source_subprocess_invoked": _safe_int(
            real_repair_noop_feedback_source_subprocess_invoked.get("true"), 0
        ),
        "real_repair_noop_feedback_source_repair_actions_executed": _safe_int(
            real_repair_noop_feedback_source_repair_actions_executed.get("true"), 0
        ),
        "real_repair_noop_feedback_source_repair_execution_enabled": _safe_int(
            real_repair_noop_feedback_source_repair_execution_enabled.get("true"), 0
        ),
        "real_repair_noop_feedback_source_repair_execution_performed": _safe_int(
            real_repair_noop_feedback_source_repair_execution_performed.get("true"), 0
        ),
        "real_repair_noop_feedback_source_repair_subprocess_invoked": _safe_int(
            real_repair_noop_feedback_source_repair_subprocess_invoked.get("true"), 0
        ),
        "real_repair_noop_feedback_feedback_execution_performed": _safe_int(
            real_repair_noop_feedback_feedback_execution_performed.get("true"), 0
        ),
        "real_repair_noop_feedback_feedback_subprocess_invoked": _safe_int(
            real_repair_noop_feedback_feedback_subprocess_invoked.get("true"), 0
        ),
        "real_repair_noop_feedback_repair_execution_enabled": _safe_int(
            real_repair_noop_feedback_repair_execution_enabled.get("true"), 0
        ),
        "real_repair_noop_feedback_real_execution_enabled": _safe_int(
            real_repair_noop_feedback_real_execution_enabled.get("true"), 0
        ),
        "real_repair_noop_feedback_subprocess_enabled": _safe_int(
            real_repair_noop_feedback_subprocess_enabled.get("true"), 0
        ),
        "real_repair_noop_feedback_repair_execution_performed": _safe_int(
            real_repair_noop_feedback_repair_execution_performed.get("true"), 0
        ),
        "real_repair_noop_feedback_repair_subprocess_invoked": _safe_int(
            real_repair_noop_feedback_repair_subprocess_invoked.get("true"), 0
        ),
        "real_repair_noop_feedback_execution_performed": _safe_int(
            real_repair_noop_feedback_execution_performed.get("true"), 0
        ),
        "real_repair_noop_feedback_subprocess_invoked": _safe_int(
            real_repair_noop_feedback_subprocess_invoked.get("true"), 0
        ),
        "real_repair_readiness_gate_observed": _safe_int(
            real_repair_readiness_gate_statuses.get("ready_blocked"), 0
        )
        > 0,
        "real_repair_readiness_gate_records": _safe_int(
            real_repair_readiness_gate_statuses.get("ready_blocked"), 0
        ),
        "real_repair_readiness_gate_linkage_complete": bool(
            trail_summary.get("real_repair_readiness_gate_linkage_complete")
        ),
        "real_repair_readiness_gate_orphans": _safe_int(
            trail_summary.get("real_repair_readiness_gate_orphans"), 0
        ),
        "real_repair_readiness_gate_ready_blocked": _safe_int(
            real_repair_readiness_gate_statuses.get("ready_blocked"), 0
        ),
        "real_repair_readiness_gate_satisfied": _safe_int(
            real_repair_readiness_gate_satisfied.get("true"), 0
        ),
        "real_repair_readiness_gate_guarded_ready": _safe_int(
            real_repair_readiness_gate_guarded_ready.get("true"), 0
        ),
        "real_repair_readiness_gate_ready_for_repair_execution": _safe_int(
            real_repair_readiness_gate_ready_for_repair_execution.get("true"), 0
        ),
        "real_repair_readiness_gate_would_execute": _safe_int(
            real_repair_readiness_gate_would_execute.get("true"), 0
        ),
        "real_repair_readiness_gate_next_action_harness": _safe_int(
            real_repair_readiness_gate_next_actions.get(
                "prepare_guarded_repair_execution_harness"
            ),
            0,
        ),
        "real_repair_readiness_gate_source_feedback_actionable": _safe_int(
            real_repair_readiness_gate_source_feedback_statuses.get("actionable"), 0
        ),
        "real_repair_readiness_gate_source_noop_completed": _safe_int(
            real_repair_readiness_gate_source_noop_statuses.get("completed"), 0
        ),
        "real_repair_readiness_gate_source_exit_code_zero": _safe_int(
            real_repair_readiness_gate_source_exit_codes.get("0"), 0
        ),
        "real_repair_readiness_gate_source_target_count_9": _safe_int(
            real_repair_readiness_gate_source_target_counts.get("9"), 0
        ),
        "real_repair_readiness_gate_source_execution_performed": _safe_int(
            real_repair_readiness_gate_source_execution_performed.get("true"), 0
        ),
        "real_repair_readiness_gate_source_subprocess_invoked": _safe_int(
            real_repair_readiness_gate_source_subprocess_invoked.get("true"), 0
        ),
        "real_repair_readiness_gate_source_repair_actions_executed": _safe_int(
            real_repair_readiness_gate_source_repair_actions_executed.get("true"), 0
        ),
        "real_repair_readiness_gate_source_repair_execution_enabled": _safe_int(
            real_repair_readiness_gate_source_repair_execution_enabled.get("true"), 0
        ),
        "real_repair_readiness_gate_source_repair_execution_performed": _safe_int(
            real_repair_readiness_gate_source_repair_execution_performed.get("true"), 0
        ),
        "real_repair_readiness_gate_source_repair_subprocess_invoked": _safe_int(
            real_repair_readiness_gate_source_repair_subprocess_invoked.get("true"), 0
        ),
        "real_repair_readiness_gate_repair_execution_enabled": _safe_int(
            real_repair_readiness_gate_repair_execution_enabled.get("true"), 0
        ),
        "real_repair_readiness_gate_real_execution_enabled": _safe_int(
            real_repair_readiness_gate_real_execution_enabled.get("true"), 0
        ),
        "real_repair_readiness_gate_subprocess_enabled": _safe_int(
            real_repair_readiness_gate_subprocess_enabled.get("true"), 0
        ),
        "real_repair_readiness_gate_repair_execution_performed": _safe_int(
            real_repair_readiness_gate_repair_execution_performed.get("true"), 0
        ),
        "real_repair_readiness_gate_repair_subprocess_invoked": _safe_int(
            real_repair_readiness_gate_repair_subprocess_invoked.get("true"), 0
        ),
        "real_repair_readiness_gate_execution_performed": _safe_int(
            real_repair_readiness_gate_execution_performed.get("true"), 0
        ),
        ...
        "real_execution_sandbox_adapter_scaffold_observed": _safe_int(
            real_execution_sandbox_adapter_scaffold_statuses.get("defined"), 0
        )
        > 0,
        "real_execution_sandbox_adapter_scaffold_records": _safe_int(
            real_execution_sandbox_adapter_scaffold_statuses.get("defined"), 0
        ),
        ...
        "real_execution_sandbox_adapter_scaffold_orphans": _safe_int(
            trail_summary.get("real_execution_sandbox_adapter_scaffold_orphans"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_defined": _safe_int(
            real_execution_sandbox_adapter_scaffold_statuses.get("defined"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_fail_closed": _safe_int(
            real_execution_sandbox_adapter_scaffold_fail_closed.get("true"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_deny_by_default": _safe_int(
            real_execution_sandbox_adapter_scaffold_deny_by_default.get("true"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_sandbox_execution_enabled": _safe_int(
            real_execution_sandbox_adapter_scaffold_sandbox_execution_enabled.get("true"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_execution_performed": _safe_int(
            real_execution_sandbox_adapter_scaffold_execution_performed.get("true"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_subprocess_invoked": _safe_int(
            real_execution_sandbox_adapter_scaffold_subprocess_invoked.get("true"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_real_execution_enabled": _safe_int(
            real_execution_sandbox_adapter_scaffold_real_execution_enabled.get("true"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_external_side_effects": _safe_int(
            real_execution_sandbox_adapter_scaffold_external_side_effects.get("true"), 0
        ),
        "real_execution_sandbox_adapter_scaffold_production_paths_mutated": _safe_int(
            real_execution_sandbox_adapter_scaffold_production_paths_mutated.get("true"), 0
        ),
        ...
        "real_execution_sandbox_request_envelope_scaffold_observed": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_statuses.get("blocked"),
            0,
        )
        > 0,
        "real_execution_sandbox_request_envelope_scaffold_records": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_statuses.get("blocked"),
            0,
        ),
        ...
        "real_execution_sandbox_request_envelope_scaffold_orphans": _safe_int(
            trail_summary.get(
                "real_execution_sandbox_request_envelope_scaffold_orphans"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_blocked": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_statuses.get("blocked"),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_fail_closed": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_fail_closed.get("true"),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_deny_by_default": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_deny_by_default.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_envelope_generation_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_envelope_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_envelope_materialized": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_envelope_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_envelope_executable": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_envelope_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_request_generation_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_request_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_workspace_creation_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_workspace_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_input_materialization_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_input_materialization_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_command_rendering_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_command_rendering_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_sandbox_execution_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_sandbox_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_result_generation_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_result_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_execution_performed": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_execution_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_subprocess_invoked": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_subprocess_invoked.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_real_execution_enabled": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_real_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_external_side_effects_performed": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_external_side_effects_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_request_envelope_scaffold_production_paths_mutated": _safe_int(
            real_execution_sandbox_request_envelope_scaffold_production_paths_mutated.get(
                "true"
            ),
            0,
        ),
        ...
        "real_execution_sandbox_workspace_plan_scaffold_observed": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_statuses.get("blocked"),
            0,
        )
        > 0,
        "real_execution_sandbox_workspace_plan_scaffold_records": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_statuses.get("blocked"),
            0,
        ),
        ...
        "real_execution_sandbox_workspace_plan_scaffold_orphans": _safe_int(
            trail_summary.get("real_execution_sandbox_workspace_plan_scaffold_orphans"),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_blocked": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_statuses.get("blocked"),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_fail_closed": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_fail_closed.get("true"),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_deny_by_default": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_deny_by_default.get("true"),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_plan_generation_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_plan_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_plan_materialized": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_plan_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_plan_executable": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_plan_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_directory_creation_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_directory_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_workspace_created": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_workspace_created.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_cleanup_registered": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_cleanup_registered.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_materialization_preflight_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_materialization_preflight_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_materialization_preflight_passed": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_materialization_preflight_passed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_envelope_generation_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_envelope_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_envelope_materialized": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_envelope_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_envelope_executable": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_envelope_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_workspace_creation_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_workspace_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_input_materialization_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_input_materialization_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_command_rendering_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_command_rendering_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_sandbox_execution_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_sandbox_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_result_generation_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_result_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_execution_performed": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_execution_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_subprocess_invoked": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_subprocess_invoked.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_real_execution_enabled": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_real_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_external_side_effects_performed": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_external_side_effects_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_production_paths_mutated": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_production_paths_mutated.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_plan_scaffold_production_secrets_accessed": _safe_int(
            real_execution_sandbox_workspace_plan_scaffold_production_secrets_accessed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_observed": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_statuses.get(
                "blocked"
            ),
            0,
        )
        > 0,
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_records": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_statuses.get(
                "blocked"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_linkage_complete": bool(
            trail_summary.get(
                "real_execution_sandbox_workspace_preparation_preflight_scaffold_linkage_complete"
            )
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_orphans": _safe_int(
            trail_summary.get(
                "real_execution_sandbox_workspace_preparation_preflight_scaffold_orphans"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_blocked": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_statuses.get(
                "blocked"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_fail_closed": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_fail_closed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_deny_by_default": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_deny_by_default.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_passed": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_passed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_generation_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_materialized": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_executable": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_directory_creation_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_directory_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_workspace_created": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_workspace_created.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_cleanup_registered": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_cleanup_registered.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_workspace_creation_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_workspace_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_input_materialization_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_input_materialization_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_command_rendering_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_command_rendering_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_sandbox_execution_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_sandbox_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_result_generation_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_result_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_execution_performed": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_execution_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_subprocess_invoked": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_subprocess_invoked.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_real_execution_enabled": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_real_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_external_side_effects_performed": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_external_side_effects_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_production_paths_mutated": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_production_paths_mutated.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_workspace_preparation_preflight_scaffold_production_secrets_accessed": _safe_int(
            real_execution_sandbox_workspace_preparation_preflight_scaffold_production_secrets_accessed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_observed": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_statuses.get(
                "blocked"
            ),
            0,
        )
        > 0,
        "real_execution_sandbox_input_materialization_plan_scaffold_records": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_statuses.get(
                "blocked"
            ),
            0,
        ...
        "real_execution_sandbox_input_materialization_plan_scaffold_orphans": _safe_int(
            trail_summary.get(
                "real_execution_sandbox_input_materialization_plan_scaffold_orphans"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_blocked": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_statuses.get(
                "blocked"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_fail_closed": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_fail_closed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_deny_by_default": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_deny_by_default.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_plan_generation_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_plan_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_plan_materialized": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_plan_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_plan_executable": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_plan_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_input_materialization_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_input_materialization_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_inputs_materialized": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_inputs_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_passed": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_passed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_directory_creation_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_directory_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_workspace_created": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_workspace_created.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_cleanup_registered": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_cleanup_registered.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_workspace_creation_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_workspace_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_command_rendering_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_command_rendering_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_sandbox_execution_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_sandbox_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_result_generation_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_result_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_execution_performed": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_execution_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_subprocess_invoked": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_subprocess_invoked.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_real_execution_enabled": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_real_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_external_side_effects_performed": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_external_side_effects_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_production_paths_mutated": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_production_paths_mutated.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_input_materialization_plan_scaffold_production_secrets_accessed": _safe_int(
            real_execution_sandbox_input_materialization_plan_scaffold_production_secrets_accessed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_observed": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_statuses.get(
                "blocked"
            ),
            0,
        )
        > 0,
        "real_execution_sandbox_command_render_plan_scaffold_records": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_statuses.get(
                "blocked"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_linkage_complete": bool(
            trail_summary.get(
                "real_execution_sandbox_command_render_plan_scaffold_linkage_complete"
            )
        ),
        "real_execution_sandbox_command_render_plan_scaffold_orphans": _safe_int(
            trail_summary.get(
                "real_execution_sandbox_command_render_plan_scaffold_orphans"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_blocked": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_statuses.get(
                "blocked"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_fail_closed": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_fail_closed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_deny_by_default": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_deny_by_default.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_plan_generation_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_plan_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_plan_materialized": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_plan_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_plan_executable": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_plan_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_command_rendering_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_command_rendering_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_command_rendered": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_command_rendered.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_rendered_command_validated": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_rendered_command_validated.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_input_plan_generation_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_input_plan_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_input_plan_materialized": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_input_plan_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_input_plan_executable": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_input_plan_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_input_materialization_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_input_materialization_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_inputs_materialized": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_inputs_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_passed": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_passed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_directory_creation_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_directory_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_workspace_created": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_workspace_created.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_cleanup_registered": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_cleanup_registered.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_workspace_creation_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_workspace_creation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_sandbox_execution_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_sandbox_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_result_generation_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_result_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_execution_performed": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_execution_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_subprocess_invoked": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_subprocess_invoked.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_real_execution_enabled": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_real_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_external_side_effects_performed": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_external_side_effects_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_production_paths_mutated": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_production_paths_mutated.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_command_render_plan_scaffold_production_secrets_accessed": _safe_int(
            real_execution_sandbox_command_render_plan_scaffold_production_secrets_accessed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_observed": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_statuses.get("blocked"),
            0,
        )
        > 0,
        "real_execution_sandbox_rendered_command_scaffold_records": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_statuses.get("blocked"),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_linkage_complete": bool(
            trail_summary.get(
                "real_execution_sandbox_rendered_command_scaffold_linkage_complete"
            )
        ),
        "real_execution_sandbox_rendered_command_scaffold_orphans": _safe_int(
            trail_summary.get(
                "real_execution_sandbox_rendered_command_scaffold_orphans"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_blocked": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_statuses.get("blocked"),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_fail_closed": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_fail_closed.get("true"),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_deny_by_default": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_deny_by_default.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_generation_enabled": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_materialized": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_materialized.get("true"),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_executable": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_executable.get("true"),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_validated": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_validated.get("true"),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_command_plan_generation_enabled": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_command_plan_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_command_plan_materialized": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_command_plan_materialized.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_command_plan_executable": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_command_plan_executable.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_command_rendering_enabled": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_command_rendering_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_command_rendered": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_command_rendered.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_sandbox_execution_enabled": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_sandbox_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_result_generation_enabled": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_result_generation_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_execution_performed": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_execution_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_subprocess_invoked": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_subprocess_invoked.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_real_execution_enabled": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_real_execution_enabled.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_external_side_effects_performed": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_external_side_effects_performed.get(
                "true"
            ),
            0,
        ),
        "real_execution_sandbox_rendered_command_scaffold_production_paths_mutated": _safe_int(
            real_execution_sandbox_rendered_command_scaffold_production_paths_mutated.get(
                "true"
            ),
            0,
        ),
        ...
        "required_fields": [
            ...
            "real_repair_noop_feedback_observed",
            ...
            "real_execution_sandbox_adapter_scaffold_observed",
            "real_execution_sandbox_adapter_scaffold_records",
            "real_execution_sandbox_adapter_scaffold_linkage_complete",
            "real_execution_sandbox_adapter_scaffold_orphans",
            "real_execution_sandbox_adapter_scaffold_defined",
            ...
            "real_execution_sandbox_adapter_request_preflight_production_paths_mutated",
            "real_execution_sandbox_adapter_request_preflight_production_secrets_accessed",
            "real_execution_sandbox_request_envelope_scaffold_observed",
            "real_execution_sandbox_request_envelope_scaffold_records",
            "real_execution_sandbox_request_envelope_scaffold_linkage_complete",
            "real_execution_sandbox_request_envelope_scaffold_orphans",
            "real_execution_sandbox_request_envelope_scaffold_blocked",
            "real_execution_sandbox_request_envelope_scaffold_fail_closed",
            "real_execution_sandbox_request_envelope_scaffold_deny_by_default",
            "real_execution_sandbox_request_envelope_scaffold_envelope_generation_enabled",
            "real_execution_sandbox_request_envelope_scaffold_envelope_materialized",
            ...
            "real_execution_sandbox_materialization_preflight_scaffold_production_paths_mutated",
            "real_execution_sandbox_materialization_preflight_scaffold_production_secrets_accessed",
            "real_execution_sandbox_workspace_plan_scaffold_observed",
            "real_execution_sandbox_workspace_plan_scaffold_records",
            "real_execution_sandbox_workspace_plan_scaffold_linkage_complete",
            "real_execution_sandbox_workspace_plan_scaffold_orphans",
            "real_execution_sandbox_workspace_plan_scaffold_blocked",
            "real_execution_sandbox_workspace_plan_scaffold_fail_closed",
            "real_execution_sandbox_workspace_plan_scaffold_deny_by_default",
            "real_execution_sandbox_workspace_plan_scaffold_plan_generation_enabled",
            "real_execution_sandbox_workspace_plan_scaffold_plan_materialized",
            ...
            "real_execution_sandbox_workspace_plan_scaffold_production_paths_mutated",
            "real_execution_sandbox_workspace_plan_scaffold_production_secrets_accessed",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_observed",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_records",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_linkage_complete",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_orphans",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_blocked",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_fail_closed",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_deny_by_default",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_enabled",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_passed",
            ...
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_production_paths_mutated",
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_production_secrets_accessed",
            "real_execution_sandbox_input_materialization_plan_scaffold_observed",
            "real_execution_sandbox_input_materialization_plan_scaffold_records",
            "real_execution_sandbox_input_materialization_plan_scaffold_linkage_complete",
            "real_execution_sandbox_input_materialization_plan_scaffold_orphans",
            "real_execution_sandbox_input_materialization_plan_scaffold_blocked",
            "real_execution_sandbox_input_materialization_plan_scaffold_fail_closed",
            "real_execution_sandbox_input_materialization_plan_scaffold_deny_by_default",
            "real_execution_sandbox_input_materialization_plan_scaffold_plan_generation_enabled",
            "real_execution_sandbox_input_materialization_plan_scaffold_plan_materialized",
            ...
            "real_execution_sandbox_input_materialization_plan_scaffold_production_paths_mutated",
            "real_execution_sandbox_input_materialization_plan_scaffold_production_secrets_accessed",
            "real_execution_sandbox_command_render_plan_scaffold_observed",
            "real_execution_sandbox_command_render_plan_scaffold_records",
            "real_execution_sandbox_command_render_plan_scaffold_linkage_complete",
            "real_execution_sandbox_command_render_plan_scaffold_orphans",
            "real_execution_sandbox_command_render_plan_scaffold_blocked",
            "real_execution_sandbox_command_render_plan_scaffold_fail_closed",
            "real_execution_sandbox_command_render_plan_scaffold_deny_by_default",
            "real_execution_sandbox_command_render_plan_scaffold_plan_generation_enabled",
            "real_execution_sandbox_command_render_plan_scaffold_plan_materialized",
            ...
            "real_execution_sandbox_command_render_plan_scaffold_production_paths_mutated",
            "real_execution_sandbox_command_render_plan_scaffold_production_secrets_accessed",
            "real_execution_sandbox_rendered_command_scaffold_observed",
            "real_execution_sandbox_rendered_command_scaffold_records",
            "real_execution_sandbox_rendered_command_scaffold_linkage_complete",
            "real_execution_sandbox_rendered_command_scaffold_orphans",
            "real_execution_sandbox_rendered_command_scaffold_blocked",
...
def _build_checks(
    *,
    ...
    checks = [
        ...
        _check(
            "real_repair_approval_transition_observed_after_repair_approval",
            _safe_int(real_repair_approval_statuses.get("pending"), 0) == 0
            or _safe_int(
                real_repair_approval_transition_to_statuses.get("approved"), 0
            )
        ...
        _check(
            "real_repair_approval_transition_links_to_repair_approval",
            _safe_int(
                real_repair_approval_transition_to_statuses.get("approved"), 0
            )
            == 0
        ...
        _check(
            "real_repair_approval_transition_from_pending",
            _safe_int(
                real_repair_approval_transition_from_statuses.get("pending"), 0
            )
            == 1,
        ...
        _check(
            "real_repair_approval_transition_to_approved",
            _safe_int(
                real_repair_approval_transition_to_statuses.get("approved"), 0
            )
            == 1,
        ...
        _check(
            "real_repair_approval_transition_source_approval_pending",
            _safe_int(
        ...
        _check(
            "real_repair_approval_transition_next_action_observed",
            _safe_int(
                real_repair_approval_transition_next_actions.get(
                    "prepare_repair_execution_final_gate"
                ),
        ...
        _check(
            ...
            _safe_int(real_repair_approval_transition_required.get("true"), 0) == 1,
            _safe_int(real_repair_approval_transition_required.get("true"), 0),
        ),
        _check(
            "real_repair_approval_transition_approved",
            _safe_int(real_repair_approval_transition_approved.get("true"), 0) == 1,
            _safe_int(real_repair_approval_transition_approved.get("true"), 0),
        ),
        _check(
            "real_repair_approval_transition_did_not_enable_repair_execution",
            _safe_int(
                real_repair_approval_transition_repair_execution_enabled.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_approval_transition_did_not_enable_real_execution",
            _safe_int(
                real_repair_approval_transition_real_execution_enabled.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_approval_transition_did_not_enable_subprocess",
            _safe_int(
                real_repair_approval_transition_subprocess_enabled.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_approval_transition_did_not_perform_repair_execution",
            _safe_int(
                real_repair_approval_transition_repair_execution_performed.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_approval_transition_did_not_invoke_repair_subprocess",
            _safe_int(
                real_repair_approval_transition_repair_subprocess_invoked.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_approval_transition_did_not_execute",
            _safe_int(
                real_repair_approval_transition_execution_performed.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_approval_transition_did_not_invoke_subprocess",
            _safe_int(
                real_repair_approval_transition_subprocess_invoked.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_noop_feedback_observed_after_noop_result",
            _safe_int(real_repair_noop_result_statuses.get("completed"), 0) == 0
            or _safe_int(real_repair_noop_feedback_statuses.get("actionable"), 0) > 0,
            {
                "completed_repair_noop_results": _safe_int(
                    real_repair_noop_result_statuses.get("completed"), 0
                ),
                "actionable_feedback_records": _safe_int(
                    real_repair_noop_feedback_statuses.get("actionable"), 0
                ),
            },
        ),
        _check(
            "real_repair_noop_feedback_links_to_noop_result",
            _safe_int(real_repair_noop_feedback_statuses.get("actionable"), 0) == 0
            or _safe_int(trail_summary.get("real_repair_noop_feedback_orphans"), 0)
            == 0,
            _safe_int(trail_summary.get("real_repair_noop_feedback_orphans"), 0),
        ),
        _check(
            "real_repair_noop_feedback_actionable",
            _safe_int(real_repair_noop_feedback_statuses.get("actionable"), 0) == 1,
            _safe_int(real_repair_noop_feedback_statuses.get("actionable"), 0),
        ),
        _check(
            "real_repair_noop_feedback_verified",
            _safe_int(real_repair_noop_feedback_verified.get("true"), 0) == 1,
            _safe_int(real_repair_noop_feedback_verified.get("true"), 0),
        ),
        _check(
            "real_repair_noop_feedback_path_can_proceed",
            _safe_int(real_repair_noop_feedback_path_can_proceed.get("true"), 0) == 1,
            _safe_int(real_repair_noop_feedback_path_can_proceed.get("true"), 0),
        ),
        _check(
            "real_repair_noop_feedback_next_gate_allowed",
            _safe_int(real_repair_noop_feedback_next_gate_allowed.get("true"), 0) == 1,
            _safe_int(real_repair_noop_feedback_next_gate_allowed.get("true"), 0),
        ),
        _check(
            "real_repair_noop_feedback_next_action_observed",
            _safe_int(
                real_repair_noop_feedback_next_actions.get(
                    "prepare_repair_execution_readiness_gate"
                ),
        ...
        _check(
            "real_repair_noop_feedback_source_noop_completed",
            _safe_int(
                real_repair_noop_feedback_source_noop_statuses.get("completed"), 0
            )
            == 1,
        ...
        _check(
            "real_repair_noop_feedback_source_exit_code_zero",
            _safe_int(real_repair_noop_feedback_source_exit_codes.get("0"), 0) == 1,
            _safe_int(real_repair_noop_feedback_source_exit_codes.get("0"), 0),
        ),
        _check(
            "real_repair_noop_feedback_source_target_count_observed",
            _safe_int(real_repair_noop_feedback_source_target_counts.get("9"), 0) == 1,
            _safe_int(real_repair_noop_feedback_source_target_counts.get("9"), 0),
        ),
        _check(
            "real_repair_noop_feedback_source_noop_executed",
            _safe_int(
                real_repair_noop_feedback_source_execution_performed.get("true"), 0
            )
            == 1,
        ...
        _check(
            "real_repair_noop_feedback_source_noop_subprocess_invoked",
            _safe_int(
                real_repair_noop_feedback_source_subprocess_invoked.get("true"), 0
            )
            == 1,
        ...
        _check(
            ...
            _safe_int(
                real_repair_noop_feedback_source_repair_actions_executed.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_noop_feedback_source_did_not_enable_repair_execution",
            _safe_int(
                real_repair_noop_feedback_source_repair_execution_enabled.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_noop_feedback_source_did_not_perform_repair_execution",
            _safe_int(
                real_repair_noop_feedback_source_repair_execution_performed.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_repair_noop_feedback_source_did_not_invoke_repair_subprocess",
            _safe_int(
                real_repair_noop_feedback_source_repair_subprocess_invoked.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_noop_feedback_did_not_execute_feedback",
            _safe_int(
                real_repair_noop_feedback_feedback_execution_performed.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_noop_feedback_did_not_invoke_feedback_subprocess",
            _safe_int(
                real_repair_noop_feedback_feedback_subprocess_invoked.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_noop_feedback_did_not_enable_repair_execution",
            _safe_int(
                real_repair_noop_feedback_repair_execution_enabled.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_noop_feedback_did_not_enable_real_execution",
            _safe_int(
                real_repair_noop_feedback_real_execution_enabled.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_noop_feedback_did_not_enable_subprocess",
            _safe_int(real_repair_noop_feedback_subprocess_enabled.get("true"), 0)
            == 0,
            _safe_int(real_repair_noop_feedback_subprocess_enabled.get("true"), 0),
        ),
        _check(
            "real_repair_noop_feedback_did_not_perform_repair_execution",
            _safe_int(
                real_repair_noop_feedback_repair_execution_performed.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_noop_feedback_did_not_invoke_repair_subprocess",
            _safe_int(
                real_repair_noop_feedback_repair_subprocess_invoked.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_noop_feedback_did_not_execute",
            _safe_int(real_repair_noop_feedback_execution_performed.get("true"), 0)
            == 0,
            _safe_int(real_repair_noop_feedback_execution_performed.get("true"), 0),
        ),
        _check(
            "real_repair_noop_feedback_did_not_invoke_subprocess",
            _safe_int(real_repair_noop_feedback_subprocess_invoked.get("true"), 0)
            == 0,
            _safe_int(real_repair_noop_feedback_subprocess_invoked.get("true"), 0),
        ),
        _check(
            "real_repair_readiness_gate_observed_after_noop_feedback",
            _safe_int(real_repair_noop_feedback_statuses.get("actionable"), 0) == 0
            or _safe_int(real_repair_readiness_gate_statuses.get("ready_blocked"), 0)
            > 0,
            {
                "actionable_feedback_records": _safe_int(
                    real_repair_noop_feedback_statuses.get("actionable"), 0
                ),
                "ready_blocked_readiness_gates": _safe_int(
                    real_repair_readiness_gate_statuses.get("ready_blocked"), 0
                ),
            },
        ),
        _check(
            "real_repair_readiness_gate_links_to_noop_feedback",
            _safe_int(real_repair_readiness_gate_statuses.get("ready_blocked"), 0) == 0
            or _safe_int(trail_summary.get("real_repair_readiness_gate_orphans"), 0)
            == 0,
            _safe_int(trail_summary.get("real_repair_readiness_gate_orphans"), 0),
        ),
        _check(
            "real_repair_readiness_gate_ready_blocked",
            _safe_int(real_repair_readiness_gate_statuses.get("ready_blocked"), 0)
            == 1,
            _safe_int(real_repair_readiness_gate_statuses.get("ready_blocked"), 0),
        ),
        _check(
            "real_repair_readiness_gate_satisfied",
            _safe_int(real_repair_readiness_gate_satisfied.get("true"), 0) == 1,
            _safe_int(real_repair_readiness_gate_satisfied.get("true"), 0),
        ),
        _check(
            "real_repair_readiness_gate_guarded_ready",
            _safe_int(real_repair_readiness_gate_guarded_ready.get("true"), 0) == 1,
            _safe_int(real_repair_readiness_gate_guarded_ready.get("true"), 0),
        ),
        _check(
            "real_repair_readiness_gate_not_ready_for_repair_execution",
            _safe_int(
                real_repair_readiness_gate_ready_for_repair_execution.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_readiness_gate_would_not_execute",
            _safe_int(real_repair_readiness_gate_would_execute.get("true"), 0)
            == 0,
            _safe_int(real_repair_readiness_gate_would_execute.get("true"), 0),
        ),
        _check(
            "real_repair_readiness_gate_next_action_observed",
            _safe_int(
                real_repair_readiness_gate_next_actions.get(
                    "prepare_guarded_repair_execution_harness"
                ),
        ...
        _check(
            "real_repair_readiness_gate_source_feedback_actionable",
            _safe_int(
                real_repair_readiness_gate_source_feedback_statuses.get("actionable"),
                0,
            )
            == 1,
            _safe_int(
        ...
        _check(
            "real_repair_readiness_gate_source_noop_completed",
            _safe_int(
                real_repair_readiness_gate_source_noop_statuses.get("completed"), 0
            )
            == 1,
        ...
        _check(
            "real_repair_readiness_gate_source_exit_code_zero",
            _safe_int(real_repair_readiness_gate_source_exit_codes.get("0"), 0) == 1,
            _safe_int(real_repair_readiness_gate_source_exit_codes.get("0"), 0),
        ),
        _check(
            "real_repair_readiness_gate_source_target_count_observed",
            _safe_int(real_repair_readiness_gate_source_target_counts.get("9"), 0)
            == 1,
            _safe_int(real_repair_readiness_gate_source_target_counts.get("9"), 0),
        ),
        _check(
            "real_repair_readiness_gate_source_noop_executed",
            _safe_int(
                real_repair_readiness_gate_source_execution_performed.get("true"), 0
            )
            == 1,
        ...
        _check(
            "real_repair_readiness_gate_source_noop_subprocess_invoked",
            _safe_int(
                real_repair_readiness_gate_source_subprocess_invoked.get("true"), 0
            )
            == 1,
        ...
        _check(
            "real_repair_readiness_gate_source_did_not_execute_repair_actions",
            _safe_int(
                real_repair_readiness_gate_source_repair_actions_executed.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_readiness_gate_source_did_not_enable_repair_execution",
            _safe_int(
                real_repair_readiness_gate_source_repair_execution_enabled.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_readiness_gate_source_did_not_perform_repair_execution",
            _safe_int(
                real_repair_readiness_gate_source_repair_execution_performed.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_readiness_gate_source_did_not_invoke_repair_subprocess",
            _safe_int(
                real_repair_readiness_gate_source_repair_subprocess_invoked.get("true"),
                0,
            )
            == 0,
            _safe_int(
        ...
        _check(
            "real_repair_readiness_gate_did_not_enable_repair_execution",
            _safe_int(
                real_repair_readiness_gate_repair_execution_enabled.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_readiness_gate_did_not_enable_real_execution",
            _safe_int(real_repair_readiness_gate_real_execution_enabled.get("true"), 0)
            == 0,
            _safe_int(real_repair_readiness_gate_real_execution_enabled.get("true"), 0),
        ),
        _check(
            "real_repair_readiness_gate_did_not_enable_subprocess",
            _safe_int(real_repair_readiness_gate_subprocess_enabled.get("true"), 0)
            == 0,
            _safe_int(real_repair_readiness_gate_subprocess_enabled.get("true"), 0),
        ),
        _check(
            "real_repair_readiness_gate_did_not_perform_repair_execution",
            _safe_int(
                real_repair_readiness_gate_repair_execution_performed.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_readiness_gate_did_not_invoke_repair_subprocess",
            _safe_int(
                real_repair_readiness_gate_repair_subprocess_invoked.get("true"), 0
            )
            == 0,
        ...
        _check(
            "real_repair_readiness_gate_did_not_execute",
            _safe_int(real_repair_readiness_gate_execution_performed.get("true"), 0)
            == 0,
            _safe_int(real_repair_readiness_gate_execution_performed.get("true"), 0),
        ),
        _check(
            "real_repair_readiness_gate_did_not_invoke_subprocess",
        ...
        _check(
            "real_execution_sandbox_adapter_scaffold_observed_after_policy_matrix",
            _safe_int(real_execution_capability_policy_matrix_statuses.get("defined"), 0) == 0
            or _safe_int(real_execution_sandbox_adapter_scaffold_statuses.get("defined"), 0) > 0,
            {
                "policy_matrices": _safe_int(
                    real_execution_capability_policy_matrix_statuses.get("defined"), 0
                ),
                "sandbox_scaffolds": _safe_int(
                    real_execution_sandbox_adapter_scaffold_statuses.get("defined"), 0
                ),
            },
        ),
        _check(
            "real_execution_sandbox_adapter_scaffold_links_to_policy_matrix",
            _safe_int(real_execution_sandbox_adapter_scaffold_statuses.get("defined"), 0) == 0
            or _safe_int(
                trail_summary.get("real_execution_sandbox_adapter_scaffold_orphans"), 0
            ) == 0,
            _safe_int(
        ...
        _check(
            "real_execution_sandbox_adapter_scaffold_defined",
            _safe_int(real_execution_sandbox_adapter_scaffold_statuses.get("defined"), 0) == 1,
            real_execution_sandbox_adapter_scaffold_statuses,
        ),
        _check(
            "real_execution_sandbox_adapter_scaffold_fail_closed",
            _safe_int(real_execution_sandbox_adapter_scaffold_fail_closed.get("true"), 0) == 1,
            real_execution_sandbox_adapter_scaffold_fail_closed,
        ),
        _check(
            "real_execution_sandbox_adapter_scaffold_deny_by_default",
            _safe_int(real_execution_sandbox_adapter_scaffold_deny_by_default.get("true"), 0) == 1,
            real_execution_sandbox_adapter_scaffold_deny_by_default,
        ),
        _check(
            "real_execution_sandbox_adapter_scaffold_does_not_enable_sandbox_execution",
            _safe_int(
                real_execution_sandbox_adapter_scaffold_sandbox_execution_enabled.get("true"), 0
            ) == 0,
            real_execution_sandbox_adapter_scaffold_sandbox_execution_enabled,
        ...
        _check(
            "real_execution_sandbox_adapter_scaffold_does_not_execute",
            _safe_int(real_execution_sandbox_adapter_scaffold_execution_performed.get("true"), 0) == 0,
            real_execution_sandbox_adapter_scaffold_execution_performed,
        ),
        _check(
            "real_execution_sandbox_adapter_scaffold_does_not_invoke_subprocess",
            _safe_int(real_execution_sandbox_adapter_scaffold_subprocess_invoked.get("true"), 0) == 0,
            real_execution_sandbox_adapter_scaffold_subprocess_invoked,
        ),
        _check(
            "real_execution_sandbox_adapter_scaffold_does_not_enable_real_execution",
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_blocked",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_statuses.get(
                    "blocked"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_links_to_request_preflight",
            _safe_int(
                trail_summary.get(
                    "real_execution_sandbox_request_envelope_scaffold_orphans"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_fail_closed",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_fail_closed.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_generate_envelope",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_envelope_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_materialize_envelope",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_envelope_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_not_executable",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_envelope_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_generate_requests",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_request_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_create_workspace",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_workspace_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_materialize_inputs",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_input_materialization_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_render_commands",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_command_rendering_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_enable_sandbox_execution",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_sandbox_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_generate_results",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_result_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_execute",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_execution_performed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_invoke_subprocess",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_subprocess_invoked.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_request_envelope_scaffold_does_not_enable_real_execution",
            _safe_int(
                real_execution_sandbox_request_envelope_scaffold_real_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_blocked",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_statuses.get(
                    "blocked"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_links_to_materialization_preflight",
            _safe_int(
                trail_summary.get(
                    "real_execution_sandbox_workspace_plan_scaffold_orphans"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_fail_closed",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_fail_closed.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_deny_by_default",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_deny_by_default.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_generate_plan",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_plan_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_materialize_plan",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_plan_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_plan_not_executable",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_plan_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_enable_directory_creation",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_directory_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_create_workspace",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_workspace_created.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_register_cleanup",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_cleanup_registered.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_enable_materialization_preflight",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_materialization_preflight_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_pass_materialization_preflight",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_materialization_preflight_passed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_generate_envelope",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_envelope_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_materialize_envelope",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_envelope_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_envelope_not_executable",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_envelope_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_enable_workspace_creation",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_workspace_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_materialize_inputs",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_input_materialization_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_render_commands",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_command_rendering_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_enable_sandbox_execution",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_sandbox_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_generate_results",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_result_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_execute",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_execution_performed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_invoke_subprocess",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_subprocess_invoked.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_plan_scaffold_does_not_enable_real_execution",
            _safe_int(
                real_execution_sandbox_workspace_plan_scaffold_real_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_links_to_workspace_plan",
            _safe_int(
                trail_summary.get(
                    "real_execution_sandbox_workspace_preparation_preflight_scaffold_orphans"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_enable_preflight",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_pass_preflight",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_preflight_passed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_generate_plan",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_materialize_plan",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_not_executable",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_plan_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_enable_directory_creation",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_directory_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_create_workspace",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_workspace_created.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_register_cleanup",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_cleanup_registered.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_enable_workspace_creation",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_workspace_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_materialize_inputs",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_input_materialization_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_render_commands",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_command_rendering_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_enable_sandbox_execution",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_sandbox_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_generate_results",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_result_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_execute",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_execution_performed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_invoke_subprocess",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_subprocess_invoked.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_does_not_enable_real_execution",
            _safe_int(
                real_execution_sandbox_workspace_preparation_preflight_scaffold_real_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_links_to_workspace_preparation_preflight",
            _safe_int(
                trail_summary.get(
                    "real_execution_sandbox_input_materialization_plan_scaffold_orphans"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_generate_plan",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_plan_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_materialize_plan",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_plan_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_plan_not_executable",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_plan_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_enable_input_materialization",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_input_materialization_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_materialize_inputs",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_inputs_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_enable_preparation_preflight",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_pass_preparation_preflight",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_preparation_preflight_passed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_enable_directory_creation",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_directory_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_create_workspace",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_workspace_created.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_register_cleanup",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_cleanup_registered.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_enable_workspace_creation",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_workspace_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_render_commands",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_command_rendering_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_enable_sandbox_execution",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_sandbox_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_generate_results",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_result_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_execute",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_execution_performed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_invoke_subprocess",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_subprocess_invoked.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_input_materialization_plan_scaffold_does_not_enable_real_execution",
            _safe_int(
                real_execution_sandbox_input_materialization_plan_scaffold_real_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_links_to_input_materialization_plan",
            _safe_int(
                trail_summary.get(
                    "real_execution_sandbox_command_render_plan_scaffold_orphans"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_generate_plan",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_plan_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_materialize_plan",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_plan_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_plan_not_executable",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_plan_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_enable_command_rendering",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_command_rendering_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_render_command",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_command_rendered.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_validate_rendered_command",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_rendered_command_validated.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_generate_input_materialization_plan",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_input_plan_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_materialize_input_plan",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_input_plan_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_input_plan_not_executable",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_input_plan_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_enable_input_materialization",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_input_materialization_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_materialize_inputs",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_inputs_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_enable_preparation_preflight",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_pass_preparation_preflight",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_preparation_preflight_passed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_enable_directory_creation",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_directory_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_create_workspace",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_workspace_created.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_register_cleanup",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_cleanup_registered.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_enable_workspace_creation",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_workspace_creation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_enable_sandbox_execution",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_sandbox_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_generate_results",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_result_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_execute",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_execution_performed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_invoke_subprocess",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_subprocess_invoked.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_command_render_plan_scaffold_does_not_enable_real_execution",
            _safe_int(
                real_execution_sandbox_command_render_plan_scaffold_real_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_blocked",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_statuses.get(
                    "blocked"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_links_to_command_render_plan",
            _safe_int(
                trail_summary.get(
                    "real_execution_sandbox_rendered_command_scaffold_orphans"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_fail_closed",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_fail_closed.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_generate_rendered_command",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_materialize_rendered_command",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_materialized.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_not_executable",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_executable.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_validate_rendered_command",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_validated.get(
                    "true"
                ),
                0,
            )
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_generate_command_render_plan",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_command_plan_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_materialize_command_render_plan",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_command_plan_materialized.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_command_render_plan_not_executable",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_command_plan_executable.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_enable_command_rendering",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_command_rendering_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_render_command",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_command_rendered.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_enable_sandbox_execution",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_sandbox_execution_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_generate_results",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_result_generation_enabled.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_execute",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_execution_performed.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_invoke_subprocess",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_subprocess_invoked.get(
                    "true"
                ),
        ...
        _check(
            "real_execution_sandbox_rendered_command_scaffold_does_not_enable_real_execution",
            _safe_int(
                real_execution_sandbox_rendered_command_scaffold_real_execution_enabled.get(
                    "true"
                ),
...
def validate_controlled_execution_readiness_report_schema(
    ...
    if not isinstance(report.get("real_repair_approval_transition_observed"), bool):
        reasons.append("real_repair_approval_transition_observed_must_be_bool")
    if not isinstance(report.get("real_repair_approval_transition_records"), int):
        reasons.append("real_repair_approval_transition_records_must_be_int")
    if not isinstance(
        report.get("real_repair_approval_transition_linkage_complete"), bool
    ):
    ...
    if not isinstance(report.get("real_repair_noop_feedback_observed"), bool):
        reasons.append("real_repair_noop_feedback_observed_must_be_bool")
    if not isinstance(report.get("real_repair_noop_feedback_records"), int):
        reasons.append("real_repair_noop_feedback_records_must_be_int")
    if not isinstance(report.get("real_repair_noop_feedback_linkage_complete"), bool):
        reasons.append("real_repair_noop_feedback_linkage_complete_must_be_bool")
    if not isinstance(report.get("real_repair_noop_feedback_orphans"), int):
        reasons.append("real_repair_noop_feedback_orphans_must_be_int")
    
    if not isinstance(report.get("real_repair_readiness_gate_observed"), bool):
        reasons.append("real_repair_readiness_gate_observed_must_be_bool")
    if not isinstance(report.get("real_repair_readiness_gate_records"), int):
        reasons.append("real_repair_readiness_gate_records_must_be_int")
    if not isinstance(report.get("real_repair_readiness_gate_linkage_complete"), bool):
    ...
    if not isinstance(
        report.get("real_execution_sandbox_adapter_scaffold_observed"), bool
    ):
        reasons.append(
            "real_execution_sandbox_adapter_scaffold_observed_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_adapter_scaffold_records"), int
    ):
        reasons.append(
            "real_execution_sandbox_adapter_scaffold_records_must_be_int"
        )
    if not isinstance(
        report.get("real_execution_sandbox_adapter_scaffold_linkage_complete"),
        bool,
    ):
        reasons.append(
            "real_execution_sandbox_adapter_scaffold_linkage_complete_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_adapter_scaffold_orphans"), int
    ):
        reasons.append(
            "real_execution_sandbox_adapter_scaffold_orphans_must_be_int"
        )
    ...
    if not isinstance(
        report.get("real_execution_sandbox_request_envelope_scaffold_observed"),
        bool,
    ):
        reasons.append(
            "real_execution_sandbox_request_envelope_scaffold_observed_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_request_envelope_scaffold_records"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_request_envelope_scaffold_records_must_be_int"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_request_envelope_scaffold_linkage_complete"
        ...
        reasons.append(
            "real_execution_sandbox_request_envelope_scaffold_linkage_complete_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_request_envelope_scaffold_orphans"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_request_envelope_scaffold_orphans_must_be_int"
        )
    ...
    if not isinstance(
        report.get("real_execution_sandbox_workspace_plan_scaffold_observed"),
        bool,
    ):
        reasons.append(
            "real_execution_sandbox_workspace_plan_scaffold_observed_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_workspace_plan_scaffold_records"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_workspace_plan_scaffold_records_must_be_int"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_workspace_plan_scaffold_linkage_complete"
        ...
        reasons.append(
            "real_execution_sandbox_workspace_plan_scaffold_linkage_complete_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_workspace_plan_scaffold_orphans"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_workspace_plan_scaffold_orphans_must_be_int"
        )
    ...
    if not isinstance(
        ...
        reasons.append(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_observed_must_be_bool"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_records"
        ...
        reasons.append(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_records_must_be_int"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_linkage_complete"
        ...
        reasons.append(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_linkage_complete_must_be_bool"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_orphans"
        ...
        reasons.append(
            "real_execution_sandbox_workspace_preparation_preflight_scaffold_orphans_must_be_int"
        )
    ...
    if not isinstance(
        report.get("real_execution_sandbox_input_materialization_plan_scaffold_observed"),
        bool,
    ):
        reasons.append(
            "real_execution_sandbox_input_materialization_plan_scaffold_observed_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_input_materialization_plan_scaffold_records"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_input_materialization_plan_scaffold_records_must_be_int"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_input_materialization_plan_scaffold_linkage_complete"
        ...
        reasons.append(
            "real_execution_sandbox_input_materialization_plan_scaffold_linkage_complete_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_input_materialization_plan_scaffold_orphans"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_input_materialization_plan_scaffold_orphans_must_be_int"
        )
    ...
    if not isinstance(
        report.get("real_execution_sandbox_command_render_plan_scaffold_observed"),
        bool,
    ):
        reasons.append(
            "real_execution_sandbox_command_render_plan_scaffold_observed_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_command_render_plan_scaffold_records"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_command_render_plan_scaffold_records_must_be_int"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_command_render_plan_scaffold_linkage_complete"
        ...
        reasons.append(
            "real_execution_sandbox_command_render_plan_scaffold_linkage_complete_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_command_render_plan_scaffold_orphans"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_command_render_plan_scaffold_orphans_must_be_int"
        )
    ...
    if not isinstance(
        report.get("real_execution_sandbox_rendered_command_scaffold_observed"),
        bool,
    ):
        reasons.append(
            "real_execution_sandbox_rendered_command_scaffold_observed_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_rendered_command_scaffold_records"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_rendered_command_scaffold_records_must_be_int"
        )
    if not isinstance(
        report.get(
            "real_execution_sandbox_rendered_command_scaffold_linkage_complete"
        ...
        reasons.append(
            "real_execution_sandbox_rendered_command_scaffold_linkage_complete_must_be_bool"
        )
    if not isinstance(
        report.get("real_execution_sandbox_rendered_command_scaffold_orphans"),
        int,
    ):
        reasons.append(
            "real_execution_sandbox_rendered_command_scaffold_orphans_must_be_int"
        )
...
def _format_result(result: Mapping[str, Any]) -> str:
    ...
    return (
        ...
        f"real_repair_approval_transition_observed={str(bool(result.get('real_repair_approval_transition_observed'))).lower()} "
        f"real_repair_approval_transition_records={result.get('real_repair_approval_transition_records', 0)} "
        f"real_repair_approval_transition_linkage_complete={str(bool(result.get('real_repair_approval_transition_linkage_complete'))).lower()} "
        f"real_repair_approval_transition_orphans={result.get('real_repair_approval_transition_orphans', 0)} "
        f"real_repair_approval_transition_from_pending={result.get('real_repair_approval_transition_from_pending', 0)} "
        f"real_repair_approval_transition_to_approved={result.get('real_repair_approval_transition_to_approved', 0)} "
        f"real_repair_approval_transition_source_approval_pending={result.get('real_repair_approval_transition_source_approval_pending', 0)} "
        f"real_repair_approval_transition_next_action_final_gate={result.get('real_repair_approval_transition_next_action_final_gate', 0)} "
        f"real_repair_approval_transition_operator_authorized={result.get('real_repair_approval_transition_operator_authorized', 0)} "
        f"real_repair_approval_transition_required={result.get('real_repair_approval_transition_required', 0)} "
        f"real_repair_approval_transition_approved={result.get('real_repair_approval_transition_approved', 0)} "
        f"real_repair_approval_transition_repair_execution_enabled={result.get('real_repair_approval_transition_repair_execution_enabled', 0)} "
        f"real_repair_approval_transition_real_execution_enabled={result.get('real_repair_approval_transition_real_execution_enabled', 0)} "
        f"real_repair_approval_transition_subprocess_enabled={result.get('real_repair_approval_transition_subprocess_enabled', 0)} "
        f"real_repair_approval_transition_repair_execution_performed={result.get('real_repair_approval_transition_repair_execution_performed', 0)} "
        ...
        f"real_repair_noop_feedback_observed={str(bool(result.get('real_repair_noop_feedback_observed'))).lower()} "
        f"real_repair_noop_feedback_records={result.get('real_repair_noop_feedback_records', 0)} "
        f"real_repair_noop_feedback_linkage_complete={str(bool(result.get('real_repair_noop_feedback_linkage_complete'))).lower()} "
        f"real_repair_noop_feedback_orphans={result.get('real_repair_noop_feedback_orphans', 0)} "
        f"real_repair_noop_feedback_actionable={result.get('real_repair_noop_feedback_actionable', 0)} "
        f"real_repair_noop_feedback_verified={result.get('real_repair_noop_feedback_verified', 0)} "
        f"real_repair_noop_feedback_path_can_proceed={result.get('real_repair_noop_feedback_path_can_proceed', 0)} "
        f"real_repair_noop_feedback_next_gate_allowed={result.get('real_repair_noop_feedback_next_gate_allowed', 0)} "
        f"real_repair_noop_feedback_next_action_readiness_gate={result.get('real_repair_noop_feedback_next_action_readiness_gate', 0)} "
        f"real_repair_noop_feedback_source_noop_completed={result.get('real_repair_noop_feedback_source_noop_completed', 0)} "
        f"real_repair_noop_feedback_source_exit_code_zero={result.get('real_repair_noop_feedback_source_exit_code_zero', 0)} "
        f"real_repair_noop_feedback_source_target_count_9={result.get('real_repair_noop_feedback_source_target_count_9', 0)} "
        f"real_repair_noop_feedback_source_execution_performed={result.get('real_repair_noop_feedback_source_execution_performed', 0)} "
        f"real_repair_noop_feedback_source_subprocess_invoked={result.get('real_repair_noop_feedback_source_subprocess_invoked', 0)} "
        f"real_repair_noop_feedback_source_repair_actions_executed={result.get('real_repair_noop_feedback_source_repair_actions_executed', 0)} "
        f"real_repair_noop_feedback_source_repair_execution_enabled={result.get('real_repair_noop_feedback_source_repair_execution_enabled', 0)} "
        f"real_repair_noop_feedback_source_repair_execution_performed={result.get('real_repair_noop_feedback_source_repair_execution_performed', 0)} "
        f"real_repair_noop_feedback_source_repair_subprocess_invoked={result.get('real_repair_noop_feedback_source_repair_subprocess_invoked', 0)} "
        f"real_repair_noop_feedback_feedback_execution_performed={result.get('real_repair_noop_feedback_feedback_execution_performed', 0)} "
        f"real_repair_noop_feedback_feedback_subprocess_invoked={result.get('real_repair_noop_feedback_feedback_subprocess_invoked', 0)} "
        f"real_repair_noop_feedback_repair_execution_enabled={result.get('real_repair_noop_feedback_repair_execution_enabled', 0)} "
        f"real_repair_noop_feedback_real_execution_enabled={result.get('real_repair_noop_feedback_real_execution_enabled', 0)} "
        f"real_repair_noop_feedback_subprocess_enabled={result.get('real_repair_noop_feedback_subprocess_enabled', 0)} "
        f"real_repair_noop_feedback_repair_execution_performed={result.get('real_repair_noop_feedback_repair_execution_performed', 0)} "
        f"real_repair_noop_feedback_repair_subprocess_invoked={result.get('real_repair_noop_feedback_repair_subprocess_invoked', 0)} "
        f"real_repair_noop_feedback_execution_performed={result.get('real_repair_noop_feedback_execution_performed', 0)} "
        f"real_repair_noop_feedback_subprocess_invoked={result.get('real_repair_noop_feedback_subprocess_invoked', 0)} "
        f"real_repair_readiness_gate_observed={str(bool(result.get('real_repair_readiness_gate_observed'))).lower()} "
        f"real_repair_readiness_gate_records={result.get('real_repair_readiness_gate_records', 0)} "
        f"real_repair_readiness_gate_linkage_complete={str(bool(result.get('real_repair_readiness_gate_linkage_complete'))).lower()} "
        f"real_repair_readiness_gate_orphans={result.get('real_repair_readiness_gate_orphans', 0)} "
        f"real_repair_readiness_gate_ready_blocked={result.get('real_repair_readiness_gate_ready_blocked', 0)} "
        f"real_repair_readiness_gate_satisfied={result.get('real_repair_readiness_gate_satisfied', 0)} "
        f"real_repair_readiness_gate_guarded_ready={result.get('real_repair_readiness_gate_guarded_ready', 0)} "
        f"real_repair_readiness_gate_ready_for_repair_execution={result.get('real_repair_readiness_gate_ready_for_repair_execution', 0)} "
        f"real_repair_readiness_gate_would_execute={result.get('real_repair_readiness_gate_would_execute', 0)} "
        f"real_repair_readiness_gate_next_action_harness={result.get('real_repair_readiness_gate_next_action_harness', 0)} "
        f"real_repair_readiness_gate_source_feedback_actionable={result.get('real_repair_readiness_gate_source_feedback_actionable', 0)} "
        f"real_repair_readiness_gate_source_noop_completed={result.get('real_repair_readiness_gate_source_noop_completed', 0)} "
        f"real_repair_readiness_gate_source_exit_code_zero={result.get('real_repair_readiness_gate_source_exit_code_zero', 0)} "
        f"real_repair_readiness_gate_source_target_count_9={result.get('real_repair_readiness_gate_source_target_count_9', 0)} "
        f"real_repair_readiness_gate_source_execution_performed={result.get('real_repair_readiness_gate_source_execution_performed', 0)} "
        f"real_repair_readiness_gate_source_subprocess_invoked={result.get('real_repair_readiness_gate_source_subprocess_invoked', 0)} "
        f"real_repair_readiness_gate_source_repair_actions_executed={result.get('real_repair_readiness_gate_source_repair_actions_executed', 0)} "
        f"real_repair_readiness_gate_source_repair_execution_enabled={result.get('real_repair_readiness_gate_source_repair_execution_enabled', 0)} "
        f"real_repair_readiness_gate_source_repair_execution_performed={result.get('real_repair_readiness_gate_source_repair_execution_performed', 0)} "
        f"real_repair_readiness_gate_source_repair_subprocess_invoked={result.get('real_repair_readiness_gate_source_repair_subprocess_invoked', 0)} "
        f"real_repair_readiness_gate_repair_execution_enabled={result.get('real_repair_readiness_gate_repair_execution_enabled', 0)} "
        f"real_repair_readiness_gate_real_execution_enabled={result.get('real_repair_readiness_gate_real_execution_enabled', 0)} "
        f"real_repair_readiness_gate_subprocess_enabled={result.get('real_repair_readiness_gate_subprocess_enabled', 0)} "
        f"real_repair_readiness_gate_repair_execution_performed={result.get('real_repair_readiness_gate_repair_execution_performed', 0)} "
