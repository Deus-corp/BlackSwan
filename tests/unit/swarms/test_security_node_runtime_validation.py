...
def test_security_node_heartbeat_reports_runtime_validation_metrics() -> None:
    ...
    assert "security_validation_retry_rendered_command_profiles" in metrics
    ...
    assert "security_validation_retry_execution_eligibility_statuses" in metrics
    ...
    assert "security_validation_controlled_execution_mock_statuses" in metrics
    assert "security_validation_controlled_execution_mock_performed" in metrics
    assert "security_validation_controlled_execution_mock_subprocess_invoked" in metrics
